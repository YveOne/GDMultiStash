...
namespace EvilsoftCommons
{
    public class IOHelper
    {
        ...
        public static int ReadInteger(FileStream fs, bool endian = false)
        {
            ...
            {
                Console.WriteLine("ReadInteger called with only {0} bytes remaining!", fs.Length - fs.Position);
                return 0;
            }
            else
            {
        ...
        public static long ReadLong(FileStream fs)
        {
            ...
            {
                Console.WriteLine("ReadLong called with only {0} bytes remaining!", fs.Length - fs.Position);
                return 0;
            }
            else
            {
        ...
        public static uint ReadUInteger(FileStream fs, bool endian = false)
        {
            ...
            if (fs.Read(array, 0, 4) != 4)
            {
                Console.WriteLine("ReadUInteger called with only {0} bytes remaining!", fs.Length - fs.Position);
                return 0;
            }
            else
            {
        ...
        public static ushort ReadUShort(FileStream fs, bool endian = false)
        {
            ...
            {
                Console.WriteLine("ReadUShort called with only {0} bytes remaining!", fs.Length - fs.Position);
                return 0;
            }
            else
            {
        ...
        public static string ReadString(FileStream fs)
        {
            ...
            {
                Console.WriteLine("ReadString requested {0} bytes but only got ... bytes", length);
            }
        ...
        public static ushort ReadShort(FileStream fs)
        {
            ...
            if (fs.Read(array, 0, 2) != 2)
            {
                Console.WriteLine("ReadShort called with only {0} bytes remaining!", fs.Length - fs.Position);
                return 0;
            }
            else
            {
