...
{
    internal class ItemSet2SortMethod : ItemSetSortMethod
    {

        public override string GroupText => Global.L.GroupSortBySet2Name();
        ...
        public override string GetSortKey(GlobalHandlers.DatabaseHandler.ItemInfo itemInfo)
        {
            ...
            return $"{itemInfo.ShownLevelRequirement.ToString().PadLeft(3, '0')}/{setName}";
        }
        ...
        public override string GetText(string key)
        {
            ...
            var split = key.Split('/');
            var itemLevel = int.Parse(split[0]);
            var setName = split[1];

            return $"[{itemLevel}] {setName}";
        }
    }
}
