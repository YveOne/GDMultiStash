...
{
    internal abstract class ItemSetSortMethod : ItemSortMethod<string>
    {
        protected Dictionary<string, string> setNamesDict = new Dictionary<string, string>();
