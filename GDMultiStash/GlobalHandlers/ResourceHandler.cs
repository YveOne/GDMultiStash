...
{
    internal partial class ResourceHandler : Base.BaseHandler
    {

        public ResourceHandler() : base()
        {
        }

        public string WriteReadResource(string resourceText, string resourceFile, char separator)
        {
