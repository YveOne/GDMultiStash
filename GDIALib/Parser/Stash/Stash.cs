...
namespace GDIALib.Parser.Stash
{
    public class Stash
    {
        ...
        public bool Read(GDCryptoDataBuffer pCrypto)
        {
            ...
            {
                Console.WriteLine($"Unexpected failure reading transfer stash, expected file to start with 2, got {this.Unknown1}. Transfer file possibly corrupted.");
                return false;
            }
            ...
            if (!pCrypto.ReadCryptoUInt(out this.Version) || (this.Version != 5u && this.Version != 4u))
            {
                Console.WriteLine($"Detected stash file version {this.Version}, only version 4 and 5 are supported");
                return false;
            }
            ...
            if (this.Version >= 5)
            {
                ...
                {
                    Console.WriteLine($"New version of transfer stash out? Cannot parse version {this.Version}");
                    return false;
                }
            }
