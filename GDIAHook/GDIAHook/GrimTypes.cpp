...
int fnGetLoadedExpansionId(GAME::Engine* engine) {
	pGetLoadedExpansionId f = pGetLoadedExpansionId(GetProcAddress(GetModuleHandle(L"engine.dll"), "?GetLoadedExpansionId@Engine@GAME@@QEBAIXZ"));
	return f(engine);
}
