...
namespace GDMultiStash.Common.Overlay
{
    public class PanelElement : Element
    {
        ...
        protected virtual D3DHook.Hook.Common.IImageResource TL { get; }
        protected virtual D3DHook.Hook.Common.IImageResource T { get; }
        protected virtual D3DHook.Hook.Common.IImageResource TR { get; }
        protected virtual D3DHook.Hook.Common.IImageResource L { get; }
        protected virtual D3DHook.Hook.Common.IImageResource M { get; }
        protected virtual D3DHook.Hook.Common.IImageResource R { get; }
        protected virtual D3DHook.Hook.Common.IImageResource BL { get; }
        protected virtual D3DHook.Hook.Common.IImageResource B { get; }
        protected virtual D3DHook.Hook.Common.IImageResource BR { get; }
